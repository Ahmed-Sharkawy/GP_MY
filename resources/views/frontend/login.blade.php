                ...
                <div class="section-login-2">
                    <div class="section-login-2-main">
                        ...
                        <form action="{{ route('login.store') }}" method="POST"
                            class="section-login-2-form needs-validation">
                            @csrf
                            @if (session()->has('error'))
                                <div style="color: red;" class="text-center">{{ session()->get('error') }}</div>
                            @endif
                            <div class="login-form-1">
                                <label for="input-email">البريد الالكتروني</label>
                                <input type="text" name="email" id="input-email" class="is-invalid"
                            ...
                            <div class="login-form-3">
                                ...
                                <input type="password" name="password" id="input-password" class="is-invalid"
                            ...
                            <div class="login-form-5">
                                <p>هل لديك حساب؟ <a href="{{ route('register') }}">انشاء حساب</a></p>
                            </div>
                        </form>
                    </div>
                </div>
