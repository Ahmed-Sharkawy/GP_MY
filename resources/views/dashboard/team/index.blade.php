    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                ...
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="mb-0 me-2">{{ $teams->count() }}</h4>
        ...
        <div class="card">
            <div class="card-header border-bottom">
                <a href="{{ route('dashboard.teams.create') }}" class="btn btn-primary waves-effect waves-light">Create
                    Team</a>
            </div>
            <div class="card-datatable table-responsive">
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                    <div class="card">
                        <h5 class="card-header">All Teams</h5>
                        <div class="">
                            <table class="table card-table">
                                ...
                                <tbody>
                                    @foreach ($teams as $team)
                                        <tr>
                                            <td>{{ $team->id }}</td>
                                            <td> <img src="{{ $team->getFirstMediaUrl() }}" width="50px" height="50px"
                                                    class="rounded-circle"></td>
                                            <td>{{ $team->name }}</td>
                                            <td>{{ $team->title }}</td>
                                            <td>{{ $team->rating }}</td>
                                            <td>{{ $team->description }}</td>
                                            <td>{{ $team->updated_at->format('Y m d') }}</td>
