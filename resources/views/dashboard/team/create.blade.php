            ...
            <div class="col-xl">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <small class="text-muted float-end">Default Team</small>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('dashboard.teams.store') }}" class="needs-validation d-flex flex-wrap justify-content-between" method="POST"
                            ...
                            <div class="mb-3 col-3">
                                ...
                                <input type="number" name="rating" value="{{ old('rating') }}" max="5"
                                    min="1" id="basic-default-phone"
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <textarea id="basic-default-message" name="description" class="form-control @error('description') is-invalid @enderror"
                                    placeholder="Hi, Do you have a moment to talk Joe?">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary waves-effect waves-light col-3">Save</button>
                        </form>
                    </div>
                </div>
            </div>
