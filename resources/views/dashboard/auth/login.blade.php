...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('backend/assets/vendor/libs/toastr/toastr.js') }} " />
...
<body>
    ...
    @if (session()->has('error'))
        ...
        <div class="bs-toast toast fade show animate__animated animate__flipInX position-absolute mt-3 me-3 end-0"
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-4 mt-2">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bold ms-1">Rehla</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1 pt-2">Welcome to Dashboard! 👋</h4>

                        <form id="formAuthentication" class="mb-3" action="{{ route('dashboard.login.store') }}"
                            method="POST">
                            @csrf
                            <div class="mb-3">
