            ...
            <div class="row">
                <div class="col-xl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('dashboard.hotels.plan.store', $hotel->id) }}"
                                ...
                                <div class="col-4 form-check form-switch">
                                    ...
                                    <input type="checkbox" name="mycosis" class="form-check-input form-control @error('price') is-invalid @enderror""
                                ...
                                <div class="col-4 form-check form-switch">
                                    ...
                                    <input type="checkbox" name="lunch" class="form-check-input form-control @error('price') is-invalid @enderror"" id="basic-default-lunch">
                                    @error('lunch')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-4 form-check form-switch">
                                    ...
                                    <input type="checkbox" name="dinner" class="form-check-input form-control @error('price') is-invalid @enderror""
